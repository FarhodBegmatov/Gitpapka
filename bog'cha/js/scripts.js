  ...
  jQuery(".contact-form").each(function(){
    ...
    jQuery(this).validate(  /*feedback-form*/{
        ...
        messages:
        {
          ...
          email:
          {
            required: 'Iltimos email ni kiriting',
            email: 'Iltimos to\'g\'ri email ni kiriting'
          },
          message:
          {
            required: 'Iltimos xabaringizni kiriting'
          },
          verify: {
          	required: 'Iltimos captcha ni kiriting',
          	remote: "Iltimos  captcha ni to'g'ri kiriting"
	      }
        },
  ...
  var submit_handler =  function (form, wrapper){
    ...
    jQuery.post("php/contacts-process.php", data, function(s_response) {
      ...
      if(s_response.info == 'success'){
        $wrapper.addClass("message message-success").append('<div class="cws_msg_box success-box clearfix"><div class="icon_section"><i class="fa fa-thumbs-up"></i></div><div class="content_section"><div class="msg_box_title">Malumot yuborildi!</div><div class="msg_box_text">Sizning xabaringiz muvaffaqiyatli jo\'natildi.</div></div></div>');
        ...
        $wrapper.addClass("cws_msg_box error-box clearfix").append("<div class='icon_section'><i class='fa fa-exclamation'></i></div><div class='content_section'><div class='msg_box_title'>Serverda xatolik!</div><div class='msg_box_text'><p>Iltimos qayta urinib ko'ring!</p></div></div>");
        $wrapper.delay(5000).hide(500, function(){
